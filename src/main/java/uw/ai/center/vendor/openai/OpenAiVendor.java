...
public class OpenAiVendor implements AiVendor {
    ...
    public List<ConfigParam> vendorParam() {
        return List.of(
                ...
                new ConfigParam( "top-p", "", TypeConfigData.FLOAT.getValue(), "top-p", "使用温度进行采样的替代方法，称为核采样，其中模型考虑具有top_p概率质量的标记的结果。所以 0.1 意味着只考虑包含前 10% 概率质量的token。我们通常建议更改此温度或温度，但不能同时更改两者。" ),
    ...
    public ChatClient buildChatClient(AiModelConfigData aiModelConfigData) {
        ...
        ConfigParamBox emtParamBox = aiModelConfigData.getEmbedParamBox();
        OpenAiApi openAiApi = OpenAiApi.builder()
                ...
                .embeddingsPath( emtParamBox.getParam( "api-path" ) )

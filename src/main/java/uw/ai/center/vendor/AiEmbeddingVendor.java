...
/**
 * EMBEDDING 能力接口。
 * <p>声明 vendor 支持向量嵌入能力，{@link #buildEmbeddingClient} 是唯一的构建入口。
...
public interface AiEmbeddingVendor extends AiVendor {
     ...
     * @return 具体的 {@link EmbeddingClient} 实例
     */
    EmbeddingClient buildEmbeddingClient(AiModelConfigData configData);
}

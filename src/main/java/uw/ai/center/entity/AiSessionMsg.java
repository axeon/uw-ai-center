...
public class AiSessionMsg implements DataEntity,Serializable{
     ...
     * RAG检索query
     */
    @ColumnMeta(columnName="rag_query", dataType="String", dataSize=65535, nullable=true)
    @Schema(title = "RAG检索query", description = "RAG检索query", maxLength=65535, nullable=true )
    private String ragQuery;

    /**
     * RAG检索是否启用
     */
    @ColumnMeta(columnName="rag_enable", dataType="int", dataSize=10, nullable=true)
    @Schema(title = "RAG检索是否启用", description = "RAG检索是否启用", maxLength=10, nullable=true )
    private int ragEnable;
    ...
    public void setRagQuery(String ragQuery){
        _UPDATED_INFO = DataUpdateInfo.addUpdateInfo(_UPDATED_INFO, "ragQuery", this.ragQuery, ragQuery, !_IS_LOADED );
     ...
     *  设置RAG检索query链式调用。
     */
    public AiSessionMsg ragQuery(String ragQuery){
        setRagQuery(ragQuery);
        return this;
    }
     ...
     * 设置RAG检索是否启用。
     */
    public void setRagEnable(int ragEnable){
        _UPDATED_INFO = DataUpdateInfo.addUpdateInfo(_UPDATED_INFO, "ragEnable", this.ragEnable, ragEnable, !_IS_LOADED );
     ...
     *  设置RAG检索是否启用链式调用。
     */
    public AiSessionMsg ragEnable(int ragEnable){
